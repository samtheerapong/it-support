...
HTML;
    ...
    {
        $message = "<a href=\"http://www.northernfood-complex.com/\" title=\"Powered by GPLI Version 10.0.6\" class=\"copyright\">";
        $message .= "NFC ";
       // if required, add GLPI version (eg not for login page)
        if ($withVersion) {
            $message .= GLPI_VERSION . " ";
        }
        $message .= "Copyright (C) 2020-" . GLPI_YEAR . " Theerapong Khanta : SaM-iT" .
         "</a>";
        return $message;
    }
    // {
